...
"""Modified from transformers.models.configuration_qwen3"""
...
class Qwen3Config(PretrainedConfig):
    ...
    def __init__(
        ...
        csc_adapter_layers: list | None =[28],
        csc_adapter_dropout: float | None =0.1,
        csc_adapter_num_heads: int | None =4,
        **kwargs,
    ):
