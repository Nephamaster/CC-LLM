"""Migrate Qwen3 embeddings and lm_head weights to the character vocabulary."""
...
from .bpe_state import write_json
...
class EmbeddingMigrator:
    ...
    def migrate(self) -> dict:
        ...
        new_vocab_size = len(char_tokenizer)
